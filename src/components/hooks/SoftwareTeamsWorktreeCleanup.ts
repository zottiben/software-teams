/**
 * SoftwareTeamsWorktreeCleanup hook component (Phase C migration).
 * Source: hooks/software-teams-worktree-cleanup.md
 */

import type { Component } from "../types";

const SoftwareTeamsWorktreeCleanup: Component = {
...
export default SoftwareTeamsWorktreeCleanup;

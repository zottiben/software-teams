...
describe("convertAgents — dryRun", () => {
  test("dryRun writes no files but populates result.written", async () => {
    ...
    expect(result.errors).toEqual([]);
    // 34 agents + AGENTS.md + RULES.md
    expect(result.written.length).toBe(36);

---
name: st-quick
description: "Software Teams: Make a quick focused code change only when the user explicitly requests a small fix"
when_to_use: "Use only for an explicit current request to make a small or quick code change; never infer it from discussion or planning approval."

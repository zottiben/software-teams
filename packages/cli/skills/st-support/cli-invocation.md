...
any call site (skills in `skills/*/SKILL.md`, agent docs in `agents/*.md`). It
...
> Resolve the CLI per
> `${CLAUDE_SKILL_DIR}/../st-support/cli-invocation.md`, then run
> `$ST_CLI state plan-ready`.
...
This convention is identical across all consuming slices (`skills/*/SKILL.md`,

...
| `/st-worktree` | Direct | Create an isolated full-environment worktree |
| `/st-worktree-merge` | Direct | Merge a Software Teams worktree back into the current branch |
| `/st-worktree-remove` | Direct | Remove a Software Teams worktree and clean up |

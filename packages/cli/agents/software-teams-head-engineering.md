...
4. **Code Quality Validation** — Verify code follows the project's stack conventions. Check: strict typing, established architectural patterns, proper test coverage, correct use of project's component library. Both domains: Australian English, proper imports, lint/type check passing.

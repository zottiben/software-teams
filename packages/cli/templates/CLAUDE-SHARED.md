...
The registered specialist catalogue is generated by `software-teams sync-agents`
from `agents/`. Do **not** hand-edit it. Claude Code loads orchestration doctrine
and team conventions natively from `.claude/rules/`.

...
Spawn the specialist natively by name. Claude Code loads the spec from `.claude/agents/jdi-pr-generator.md` (generated by `jdi sync-agents` from `framework/agents/jdi-pr-generator.md`):

```
Agent(
  subagent_type="jdi-pr-generator",
  mode="acceptEdits",

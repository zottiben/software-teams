...
Spawn the reviewer natively by name. Claude Code loads the spec from `.claude/agents/jdi-quality.md` (generated by `jdi sync-agents` from `framework/agents/jdi-quality.md`):

```
Agent(
  subagent_type="jdi-quality",
  mode="acceptEdits",

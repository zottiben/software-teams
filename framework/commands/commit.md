...
Spawn the committer natively by name. Claude Code loads the spec from `.claude/agents/jdi-committer.md` (generated by `jdi sync-agents` from `framework/agents/jdi-committer.md`):

```
Agent(
  subagent_type="jdi-committer",
  mode="acceptEdits",
